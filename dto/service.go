...
type ServiceAddHTTPInput struct {
	...
	NeedWebsocket  int    `json:"need_websocket" form:"need_websocket" comment:"是否支持websocket" example:"" validate:"max=1,min=0"`        //是否支持websocket
	UrlRewrite     string `json:"url_rewrite" form:"url_rewrite" comment:"url重写功能" example:"" validate:"valid_url_rewrite"`              //url重写功能
	HeaderTransfer string `json:"header_transfer" form:"header_transfer" comment:"header转换" example:"" validate:"valid_header_transfor"` //header转换
...
func (params *AddGrpcServiceInput) GetValidParams(c *gin.Context) error {
...
func (params *UpdateGrpcServiceInput) GetValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
...
func (params *AddTCPServiceInput) GetValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
...
func (params *UpdateTCPServiceInput) GetValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
